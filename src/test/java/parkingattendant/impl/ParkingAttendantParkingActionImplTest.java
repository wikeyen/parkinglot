...
class ParkingAttendantParkingActionImplTest {
    @Test
    void should_parking_into_the_first_parking_lot_and_get_a_ticket_when_parking_given_one_car_and_two_not_full_parking_lot() throws NoCarToParkException, FullyOccupiedParkingLotException, NoParkingLotException {
    ...
    @Test
    void should_parking_into_the_second_parking_lot_and_get_a_ticket_when_parking_given_one_car_and_two_parking_lots_with_the_first_one_fully_occupied() throws NoCarToParkException, FullyOccupiedParkingLotException, NoParkingLotException {
